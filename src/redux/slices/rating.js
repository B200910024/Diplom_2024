...
export function fetchRatingList(body = {}) {
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axiosGeneral.get('/ratings', body);
      dispatch(slice.actions.getRatingList(response.data));
    } catch (error) {
